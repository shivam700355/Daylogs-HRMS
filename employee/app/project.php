...
$listing = new Listing();
$count = new Count();
$project = $listing->project($_SESSION['u_id']);
        ...
        <div class="card card-default">
          <div class="card-header">
            ...
            <div class="card-tools">
              <!-- <a data-toggle="modal" data-target="#addProjectReport" class="btn btn-tbl-edit btn-xs btn-primary"><i
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      while ($row = $project->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        $member = $count->project_member_count($row['id']);
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?php echo date('j M, y', strtotime($row['s_date'])); ?></td>
                          <td><?php echo date('j M, y', strtotime($row['e_date'])); ?></td>

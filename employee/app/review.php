                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo ($rating > 0) ? str_repeat("&#9733;", $rating) . "($rating)" : "--"; ?></td>
                                                    <td><?php echo $row['review']; ?></td>
                                                    
                                                    <td>
                                                        <!-- <a class="btn btn-tbl-edit btn-xs btn-primary"><i class="fa fa-star"></i></a> -->
                                                        <a href="#" class="btn btn-tbl-edit btn-xs btn-primary"><i class="fa fa-eye"></i></a>
                                                    </td>

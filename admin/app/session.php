...
<?php
$listing = new Listing();
$employee_session = $listing->employee_session($_SESSION['cid']);
?>
                                    ...
                                    <div class="table-responsive"> <!-- Add this div for responsiveness -->
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                $i = 0;
                                                while ($row = $employee_session->fetch(PDO::FETCH_ASSOC)) {
                                                    $i++;
                                                    $id = $row['u_id'];
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="delete btn btn-tbl-delete btn-xs btn-danger">

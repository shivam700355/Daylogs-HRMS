...
<head>
  ...
  <title>DayLogs | Document List</title>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      while ($row = $user->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        $documents = $listing->document($id);

                        // Initialize variables for Aadhaar and PAN
                        $aadhaar = "--";
                        $pan = "--";
                        $resume = "--";
                        $offer_letter = "--";
                        ...
                        // Iterate over the documents to find Aadhaar and PAN
                        foreach ($documents as $document) {
                          if ($document['doc_type'] == 'Aadhaar') {
                            $aadhaar = $document['doc_number'];
                          } elseif ($document['doc_type'] == 'PAN') {
                            $pan = $document['doc_number'];
                          }
                          elseif ($document['doc_type'] == 'Resume') {
                            $resume = $document['doc_number'];
                          }
                          elseif ($document['doc_type'] == 'Offer Letter') {
                            $offer_letter = $document['doc_number'];
                          }
                          elseif ($document['doc_type'] == 'Resign Letter') {
                            $resign_letter = $document['doc_number'];
                          }
                          elseif ($document['doc_type'] == 'Relieving Letter') {
                            $relieving_letter = $document['doc_number'];
                          }
                        }
                      ?>
                        <tr>
                          ...
                          <td><?php echo $offer_letter; ?></td>
                          <td><?php echo $resign_letter; ?></td>
                          <td><?php echo $relieving_letter; ?></td>
                          <td>

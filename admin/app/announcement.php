...
<?php
$listing = new Listing();
$user = $listing->announcement($_SESSION["cid"]);
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo date("d M y, D", strtotime($row['a_date'])); ?></td>
                                                    <td><?php echo str_word_count($row['a_desc']) > 20 ? implode(' ', array_slice(explode(' ', $row['a_desc']), 0, 20)) . '......' : $row['a_desc']; ?></td>
                                                    <td>
                                                        <label class="switch">
                                            ...
                                            <div class="modal-body">
                                                <form id="announcement_form">
                                                    <div class="mb-3 col-md-12">
                                                        <label for="a_name" class="form-label">Announcement Title</label>
                                                        <input type="text" class="form-control" id="a_name" name="a_name" required>
                                                    </div>
                                                    <div class="mb-3 col-md-12">
                                                        <label for="a_date" class="form-label">Announcement Date</label>
                                                        <input type="date" class="form-control" id="a_date" name="a_date" min="<?php echo date('Y-m-d'); ?>" required>
                                                    </div>
                                                    <div class="mb-3 col-md-12">
                                                        <label for="a_desc" class="form-label">Announcement Description</label>
                                                        <textarea class="form-control" id="a_desc" name="a_desc" rows="3" required></textarea>
                                                    </div>
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function() {
            ...
            $(document).on('submit', '#announcement_form', function(e) {
                ...
                if (a_name != '' && a_date != '' && h_desc != '') {
                    $.ajax({
                        url: "action/add_announcement",
                        method: 'POST',

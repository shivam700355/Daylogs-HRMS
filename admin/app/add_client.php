                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="ca_name" name="ca_name" placeholder="Enter Company Short Name" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Company Contact Number</label>
                                            <input type="text" class="form-control" id="c_contact" name="c_contact" placeholder="Enter Company Contact Number" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Company Email</label>
                                            <input type="email" class="form-control" id="c_email" name="c_email" placeholder="Enter Company Email">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Company Website</label>
                                            <input type="text" class="form-control" id="c_website" name="c_website" placeholder="Enter Company Website">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="c_pan" name="c_pan" placeholder="Enter Company PAN Number">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Company GSTIN Number</label>
                                            <input type="text" class="form-control" id="c_gst" name="c_gst" placeholder="Enter Company GSTIN Number">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Company Address</label>
                                            <input type="text" class="form-control" id="c_address" name="c_address" placeholder="Enter Company Address">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>State</label>
                                            <select class="form-control" name="c_state" id="c_state" style="width: 100%;">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="c_district" id="c_district" style="width: 100%;">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Pincode</label>
                                            <input type="text" class="form-control" id="c_pincode" name="c_pincode" placeholder="Enter Pincode" required>
                                        </div>
                                    </div>
                                </div>
                            </div>

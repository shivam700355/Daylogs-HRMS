...
<?php
$listing = new Listing();
$user = $listing->user_list($_SESSION["cid"]);
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="card card-default">
          <div class="card-header">
            ...
            <div class="card-tools">
              <a href="add_user" class="btn btn-tbl-edit btn-xs btn-primary"><i class="fa fa-plus"></i></a>
            </div>
          </div>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="user_dashboard?id=<?php echo $row['u_id']; ?>" class="btn btn-tbl-edit btn-xs btn-primary">

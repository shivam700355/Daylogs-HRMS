...
<head>
  ...
  <title>DayLogs | Client List</title>
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="card card-default">
          <div class="card-header">
            ...
            <div class="card-tools">
              <a href="add_client" class="btn btn-tbl-edit btn-xs btn-primary"><i class="fa fa-plus"></i></a>
            </div>
          </div>
                    ...
                    <tbody>
                      ...
                      while ($row = $client->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        <tr>
                          <td><?php echo $i; ?></td>
                          <td>
                            <img src="../app-assets/images/client/<?php echo $row['image']; ?>"
                              alt="<?= $row['image']; ?>" style="height: 40px;width: 40px; border-radius: 50%;""></td>
                          ...
                          <td><label class=" switch">
                            ...
                            ?>
                            <input type="checkbox" <?php echo $activeText; ?> class="active"
                              id='<?php echo $row['id'] . '_' . $active ?>'><span class="slider"></span></label>
                          </td>
                          <td>
                            <!-- <a href="client_dashboard?id=<?php echo $row['u_id']; ?>" target="_blank" class="btn btn-tbl-edit btn-xs btn-primary">
  ...
  <script>
    $('#company-form').on('submit', async function (event) {
      event.preventDefault();
      var formData = new FormData(document.getElementById('company-form'));
      var response = await fetch('https://daylogs.in/manage/app/action/company.php', {
        method: 'POST',
        body: formData
      });

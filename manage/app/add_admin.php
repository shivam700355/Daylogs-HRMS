              ...
              <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="company" id="company" style="width: 100%;">
                        ...
                        while ($row = $client->fetch(PDO::FETCH_ASSOC)) {
                          echo '<option value="' . $row["id"] . '">' . $row["id"].'-' .$row["abb_name"].'</option>';
                        }
                        ?>
                      </select>
                    </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>Role</label>
                      <input type="text" class="form-control" id="role" name="role" placeholder="Enter Role"  value="Admin" disabled>
                    </div>

...
<head>
  ...
  <title>DayLogs | Admin List</title>
        ...
        <div class="card card-default">
          <div class="card-header">
            ...
            <div class="card-tools">
              <a href="add_admin" class="btn btn-tbl-edit btn-xs btn-primary"><i class="fa fa-plus"></i></a>
            </div>
          </div>
                        ...
                        <tr>
                          ...
                          <td><label class="switch">
                              ...
                              <input type="checkbox" <?php echo $activeText; ?> class="active"
                                id='<?php echo $id . '_' . $active ?>'><span class="slider"></span></label>
                          </td>
                          <td>
                            <a href="client_dashboard?id=<?php echo $row['u_id']; ?>" target="_blank"
